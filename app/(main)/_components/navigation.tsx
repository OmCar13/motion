...
import { ChevronsLeft, Menu, Plus, Settings, Trash } from "lucide-react";
...
export const Navigation = () => {
    ...
    const collapse = () => {
        if (sidebarRef.current && navbarRef.current) {
            ...
            navbarRef.current.style.transition = "left 0.3s ease, width 0.3s ease";
            ...
            >
                <div
                    ...
                    className={cn(
                        ...
                        top-3 right-2 opacity-100 cursor-pointer transition`,
